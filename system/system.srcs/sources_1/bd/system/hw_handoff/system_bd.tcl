...
proc create_hier_cell_vdma_out_mm2s { parentCell nameHier } {
  ...
  # Create instance: mm2s_axis_ila, and set properties
  set mm2s_axis_ila [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:6.2 mm2s_axis_ila ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets axi_vdma_mm2s_M_AXIS_MM2S] [get_bd_intf_pins M_AXIS_MM2S] [get_bd_intf_pins mm2s_axis_ila/SLOT_0_AXIS]
  ...
  connect_bd_net -net m_axis_mm2s_aclk_1 [get_bd_pins pix_clk] [get_bd_pins axi_vdma_mm2s/m_axis_mm2s_aclk] [get_bd_pins mm2s_axis_ila/clk] [get_bd_pins mm2s_ila/clk]
...
proc create_hier_cell_Zynq_system { parentCell nameHier } {
  ...
  connect_bd_net -net clk_150_200_150_clk_out1 [get_bd_pins pix_clk150] [get_bd_pins pix_clk/pix_clk150] [get_bd_pins ps7_0_axi_periph/M03_ACLK]
  connect_bd_net -net proc_sys_reset_150M_peripheral_aresetn [get_bd_pins per_pix_aresetn150] [get_bd_pins pix_clk/per_pix_aresetn150] [get_bd_pins ps7_0_axi_periph/M03_ARESETN]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK2 [get_bd_pins HP_Interconnect_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK2] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP1_ACLK] [get_bd_pins rst_ps7_0_250M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_lite_ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
...
proc create_hier_cell_TPG { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets Conn1] [get_bd_intf_pins AXIS_TPG] [get_bd_intf_pins ila_tpg/SLOT_0_AXIS]
  ...
  # Create port connections
  connect_bd_net -net ap_clk_1 [get_bd_pins pix_clk] [get_bd_pins axis_24to32_converter/aclk] [get_bd_pins ila_tpg/clk] [get_bd_pins v_tpg/ap_clk]
...
proc create_hier_cell_HDMI_OUT { parentCell nameHier } {
  ...
  # Create instance: ila_video_out_stream, and set properties
  set ila_video_out_stream [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:6.2 ila_video_out_stream ]
  set_property -dict [ list \
   CONFIG.C_DATA_DEPTH {8192} \
   CONFIG.C_NUM_OF_PROBES {9} \
   CONFIG.C_SLOT_0_AXI_PROTOCOL {AXI4S} \
 ] $ila_video_out_stream
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets axis_32to24_converter_M_AXIS] [get_bd_intf_pins axis_32to24_converter/M_AXIS] [get_bd_intf_pins ila_video_out_stream/SLOT_0_AXIS]

  # Create port connections
  connect_bd_net -net Net [get_bd_pins pix_clk] [get_bd_pins axis_32to24_converter/aclk] [get_bd_pins hdmi_vid_out/aclk] [get_bd_pins ila_video_out/clk] [get_bd_pins ila_video_out_stream/clk] [get_bd_pins rgb2dvi/PixelClk] [get_bd_pins v_tc/clk]
...
proc create_root_design { parentCell } {
  ...
  set pl_switch [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 pl_switch ]
  ...
  # Create instance: PL_Switch, and set properties
  set PL_Switch [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 PL_Switch ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net PL_Switch_GPIO [get_bd_intf_ports pl_switch] [get_bd_intf_pins PL_Switch/GPIO]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins PL_Switch/S_AXI] [get_bd_intf_pins Zynq_system/M00_AXI]
  ...
  # Create port connections
  connect_bd_net -net ARESETN_1 [get_bd_pins Zynq_system/HP_interconnect_aresetn] [get_bd_pins vdma_in_s2mm/Interconnect_ARESETN] [get_bd_pins vdma_out_mm2s/Interconnect_ARESETN]
  connect_bd_net -net M00_ARESETN_1 [get_bd_pins Zynq_system/HP_peripheral_aresetn] [get_bd_pins vdma_in_s2mm/periphera_ARESETN] [get_bd_pins vdma_out_mm2s/periphera_ARESETN]
  connect_bd_net -net PL_Switch_ip2intc_irpt [get_bd_pins PL_Switch/ip2intc_irpt] [get_bd_pins Zynq_system/intr_0]
  connect_bd_net -net Zynq_system_FCLK_CLK2 [get_bd_pins Zynq_system/HP_Interconnect_ACLK] [get_bd_pins vdma_in_s2mm/Interconnect_ACLK] [get_bd_pins vdma_out_mm2s/Interconnect_ACLK]
  connect_bd_net -net Zynq_system_peripheral_aresetn [get_bd_pins HDMI_OUT/pix_aresetn] [get_bd_pins TPG/pix_rst_n] [get_bd_pins Zynq_system/per_pix_aresetn150]
  ...
  connect_bd_net -net pix_clk [get_bd_pins HDMI_OUT/pix_clk] [get_bd_pins TPG/pix_clk] [get_bd_pins Zynq_system/pix_clk150] [get_bd_pins vdma_in_s2mm/pix_clk] [get_bd_pins vdma_out_mm2s/pix_clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins PL_Switch/s_axi_aclk] [get_bd_pins Zynq_system/axi_lite_CLK] [get_bd_pins vdma_in_s2mm/s_axi_lite_aclk] [get_bd_pins vdma_out_mm2s/s_axi_lite_aclk]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins PL_Switch/s_axi_aresetn] [get_bd_pins Zynq_system/axi_lite_ARESETN] [get_bd_pins vdma_in_s2mm/axi_resetn] [get_bd_pins vdma_out_mm2s/axi_resetn]
  connect_bd_net -net vdma_in_s2mm_s2mm_introut [get_bd_pins Zynq_system/intr_1] [get_bd_pins vdma_in_s2mm/s2mm_interrupt]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces Zynq_system/processing_system7_0/Data] [get_bd_addr_segs PL_Switch/S_AXI/Reg] SEG_PL_Switch_Reg
