...
HD_PWD='C:/Xilinx/workspace/2018.3/zybo_GrabberBoard/system/system.runs/system_ila_0_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_ila_0_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_ila_0_4.tcl
